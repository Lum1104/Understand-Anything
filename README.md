...
<p align="center">
  ...
  <a href="#kiro"><img src="https://img.shields.io/badge/Kiro-FF9900" alt="Kiro" /></a>
...
Via Kiro Power (recommended): Open the Powers panel in Kiro → Import from GitHub → ‎`Lum1104/Understand-Anything`. This enables keyword-based auto-activation and dynamic context loading — the power only loads into context when you mention relevant terms like “codebase”, “knowledge graph”, or “architecture”, saving tokens.
