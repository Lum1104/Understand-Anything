...
<p align="center">
  ...
  <br />
  <em>支援 Claude Code、Codex、Cursor、Copilot、Antigravity CLI 等多平台。</em>
</p>
...
### 一行指令安裝（Codex / OpenCode / OpenClaw / Antigravity / Antigravity CLI / Pi Agent / Vibe CLI / VS Code Copilot / Hermes / Cline / KIMI CLI）
...
- 支援的 `<platform>` 取值：`antigravity`、`codex`、`opencode`、`pi`、`openclaw`、`vibe`、`vscode`、`hermes`、`cline`、`kimi`
...
| Antigravity CLI | ✅ 支援 | `install.sh antigravity` |
