...
<p align="center">
  ...
  <br />
  <em>Claude Code, Codex, Cursor, Copilot, Antigravity CLI 등 다양한 플랫폼을 지원합니다.</em>
</p>
...
### 한 줄 설치 (Codex / OpenCode / OpenClaw / Antigravity / Antigravity CLI / Pi Agent / Vibe CLI / VS Code Copilot / Hermes / Cline / KIMI CLI)
...
- 지원되는 `<platform>` 값: `antigravity`, `codex`, `opencode`, `pi`, `openclaw`, `vibe`, `vscode`, `hermes`, `cline`, `kimi`
...
| Antigravity CLI | ✅ 지원 | `install.sh antigravity` |
