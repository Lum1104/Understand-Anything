...
export function buildResult(file, totalLines, nonEmptyLines, analysis, callGraph, batchImportData) {
  ...
  // file-analyzer can emit deterministic inherits/implements edges without
  // re-reading source.
  ...
  // Imports (code files) — surface section info (Pascal interface vs
  // implementation uses) so file-analyzer can characterize dependency direction.
