...
export function buildOnboardingGuide(graph: KnowledgeGraph): string {
  ...
  return [
    ...
    renderUntrustedDataBlock("generated onboarding content from graph", generatedBody),
    "---",
    "",
    "*Generated by [Understand Anything](https://github.com/Lum1104/Understand-Anything) from an Understand-Anything knowledge graph.*",
    "",
  ].join("\n");
}
