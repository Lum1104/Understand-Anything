...
describe("generateStarterIgnoreFile", () => {
  ...
  describe(".gitignore integration", () => {
    it("includes non-sensitive .gitignore patterns not covered by defaults", () => {
    ...
    it("excludes .gitignore patterns already in defaults or sensitive hard-deny", () => {
    ...
    it("skips .gitignore comments, blank lines, and sensitive hard-deny patterns", () => {
    ...
    it("handles .gitignore with trailing-slash normalization for defaults", () => {
      ...
      expect(patterns).toContain("custom-cache");
